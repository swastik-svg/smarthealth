  ...
  const navItems = [
    ...
    { 
       ...
       children: [
          ...
          { view: AppView.MCH, label: 'Maternal & Child Health', icon: Baby, hidden: !permissions.accessMCH },
          { view: AppView.IMMUNIZATION, label: 'Immunization (खोप)', icon: Syringe, hidden: !permissions.accessImmunization },
          { view: AppView.TB_LEPROSY, label: 'TB & Leprosy', icon: Activity, hidden: !permissions.accessTB },
          { view: AppView.NUTRITION, label: 'Nutrition', icon: Apple, hidden: !permissions.accessNutrition },
          { view: AppView.CBIMNCI, label: 'CBIMNCI', icon: Baby, hidden: !permissions.accessCBIMNCI },
          { view: AppView.COMMUNICABLE, label: 'Communicable Disease', icon: Activity, hidden: !permissions.accessCommunicable },
          { view: AppView.RABIES_VACCINE, label: 'Rabies Vaccine', icon: Syringe, hidden: !permissions.accessRabies },
    ...
    { 
       ...
       children: [
          ...
          { view: AppView.REPORT_RABIES, label: 'Rabies Report', icon: FileText },
          { view: AppView.REPORT_SERVICE_USER, label: 'Service User Report', icon: FileText },
       ]
    },
